...
public class HammerAnimations {
    ...
    public static StaticAnimation SLAM_FIRST;
    public static StaticAnimation SLAM_SECOND;
    ...
    private static void build() {
        ...
        HAMMER_AIRSLAM = new AirSlashAnimation(0.1F, 0.2F, 0.5F, 0.9F, (Collider)null, biped.toolR, "biped/combat/hammer_airslam", biped).addProperty(AttackPhaseProperty.STUN_TYPE, StunType.KNOCKDOWN);
