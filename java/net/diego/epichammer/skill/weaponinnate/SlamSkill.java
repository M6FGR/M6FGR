package net.diego.epichammer.skill.weaponinnate;
...
public class SlamSkill extends WeaponInnateSkill {
    ...
    private AnimationProvider.AttackAnimationProvider first = () -> {
        return (AttackAnimation) HammerAnimations.SLAP_FIRST;
    };
    private AnimationProvider.AttackAnimationProvider second = () -> {
        return (AttackAnimation) HammerAnimations.SLAP_SECOND;
    };

    public SlamSkill(Builder<? extends Skill> builder) { super(builder); }

    public void onInitiate(SkillContainer container) {
        super.onInitiate(container);
        container.getExecuter().getEventListener().addEventListener(EventType.ATTACK_ANIMATION_END_EVENT, EVENT_UUID, (event) -> {
            if (HammerAnimations.SLAP_FIRST.equals(event.getAnimation())) {
